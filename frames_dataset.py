...
class AudioDataset(Dataset):
    ...
    def __init__(self, name, root_dir, frame_shape=(256, 256, 3), id_sampling=False, is_train=True,
      ...
      #  self.videos = os.listdir(self.landmark_dir)
        ...
        # train_mfccs_path = glob.glob(os. path.join(self.audio_dir,"*/train_mfcc/*.npy"))
        # test_mfccs_path = glob.glob(os. path.join(self.audio_dir,"*/test_mfcc/*.mp4"))
        
        # train_poses_path = glob.glob(os. path.join(self.audio_dir,"*/train_pose/*.mp4"))
        # test_poses_path = glob.glob(os. path.join(self.audio_dir,"*/test_pose/*.mp4"))

        # train_2d_sparse_path = glob.glob(os. path.join(self.audio_dir,"*/train_2d_sparse/*.mp4"))
        # test_2d_sparse_path = glob.glob(os. path.join(self.audio_dir,"*/test_2d_sparse/*.mp4"))
    ...
    def __getitem__(self, idx):
        ...
        mfccs = np.load(os.path.join(audio_path, basename +'.npy'))[r+1:r+17, 1:]
        poses = np.load(os.path.join(pose_path, basename +'.npy')) [r+1:r+17, :-1]
        video_array = np.array(video_array)[r+1:r+17]
