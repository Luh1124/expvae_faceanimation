...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", default="config/train_part1_fine_tune.yaml", help="path to config")# required=True
    parser.add_argument("--mode", default="train_part1_fine_tune", choices=["train_part1", "train_part1_fine_tune", "train_part2"])
